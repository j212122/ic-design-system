...
import { IcAccordion, IcAccordionGroup, SlottedSVG } from "@ukic/react";
...
An accordion is an expandable and collapsible section which is used to show and hide content. Accordions are used to shorten the length of a page by hiding information.
...
<ComponentPreview style={{flexDirection: "column"}}>
  <IcAccordionGroup groupTitle="Title of the Accordion Group">
    ...
    <IcAccordion heading="Accordion 2">
      ...
      <IcAccordion heading="Nested Accordion 1">
        <IcTypography variant="body">
          This is an example of the nested accordion body text
        </IcTypography>
      </IcAccordion>
      <IcAccordion heading="Nested Accordion 2">
        <IcTypography variant="body">
          This is an example of the nested accordion body text
        </IcTypography>
      </IcAccordion>
...
Specify an accordion to open one at once when the information in the accordions is unrelated.

Specify an accordion to open all at once when all information can be viewed at the same time and is related.
